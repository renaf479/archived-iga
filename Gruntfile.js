        ...
        uglify: {
		    build: {
		        files: {
		            ...
		            'app/webroot/js/results.min.js': ['app/webroot/js/plugins/angular.min.js', 'app/webroot/js/results/app.js', 'app/webroot/js/results/controller.js', 'app/webroot/js/iga/services.js'],             
		        }
		    }
		},
		watch: {
			scripts: {
				files: [path+'js/iga/*.js', path+'css/*.css', path+'js/results/*.js'],
				tasks: ['uglify', 'cssmin'],
				options: {
				  spawn: false
				}
